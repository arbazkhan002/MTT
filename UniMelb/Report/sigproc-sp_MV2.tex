...
\title{Extracting Spatial Information From Place Descriptions}%\titlenote{(Does NOT produce the permission block, copyright information nor page numbering). For use with ACM\_PROC\_ARTICLE-SP.CLS. Supported by ACM.}}
...
\category{H.3.1}{Information Storage and Retrieval}Computational Linguistics
...
Thereafter, we work with simple reasoning methods to form rules for extracting useful spatial information from the text. 
...
\epsfig{file=phase1.eps, height=2in, width=1.5in}
...
\centering
%\includegraphics[width=0.5\textwidth]{phase1.png}
\epsfig{file=IOB.eps, height=0.33in, width=3in}
